...
class Project(models.Model):
    ...
    alertedContacts = models.ManyToManyField(Contact, blank=True, verbose_name='Emails to send alerts to', help_text='Note: you will automatically recieve an email, no need to add your email here.    ')
    ...
    notified_up = models.BooleanField(default=False, editable=False)
    notified_down = models.BooleanField(default=False, editable=False)
